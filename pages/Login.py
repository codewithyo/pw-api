...
with fetch_new_quiz_assignment:
    ...
    if type_ is not None:
        try:
            ...
            msg.error(
                f'Re-click the {type_!r} button to restart the fetching process.'
            )
...
with save_quiz_assignment_json:
    ...
    l.download_button(
        ...
        data=(dumps(load(open(quiz_fp)), indent=2)
              if quiz_fp.exists() else '[]'),
    ...
    r.download_button(
        ...
        data=(dumps(load(open(assignment_fp)), indent=2)
